...
class CheckSuite(unittest.TestCase):
    ...
    def test_case_48(self):
        ...
        Parameter: m
        Body:
            test(int_of_float(float_to_int(m)));
        EndBody.
        Function: foo
        Body:
            Return test(b);
    ...
    def test_case_98(self):
        ...
        Parameter: x
        Body:
            If foo(float_to_int(x))[3] == 2 Then
            ElseIf b[x] != b[0] Then
            EndIf.
    ...
    def test_case_112(self):
        ...
        Function: f
        Body:
            Return float_to_int(x[0]);
        EndBody.
        """
        expect = str(TypeMismatchInStatement(Return(CallExpr(Id('float_to_int'),[ArrayCell(Id('x'),[IntLiteral(0)])]))))
